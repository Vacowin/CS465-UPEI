...
bool ExampleGame::Init()
{
	...
	pCharacter->GetTransform().SetTranslation(glm::vec3(-25.0f, 0.0f, -25.0f));
	...
	pRenderableComponent->Init("week9/ExampleGame/data/character/vincent.pod", "week9/ExampleGame/data/character/", "week9/ExampleGame/data/skinned.vsh", "week9/ExampleGame/data/skinned.fsh");
	...
	pRenderableComponent->Init("week9/ExampleGame/data/zombie/zombie.pod", "week9/ExampleGame/data/zombie/", "week9/ExampleGame/data/skinned.vsh", "week9/ExampleGame/data/skinned.fsh");
