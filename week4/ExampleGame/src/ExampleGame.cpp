...
bool ExampleGame::Init()
{
	...
	pRenderableComponent->Init("week4/ExampleGame/data/character/vincent.pod", "week4/ExampleGame/data/character/", "week4/ExampleGame/data/skinned.vsh", "week4/ExampleGame/data/skinned.fsh");
