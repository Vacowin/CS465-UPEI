...
void StateGameplay::Enter()
{
	...
	pRenderableComponent->Init("week6/ExampleGame/data/character/vincent.pod", "week6/ExampleGame/data/character/", "week6/ExampleGame/data/skinned.vsh", "week6/ExampleGame/data/skinned.fsh");
