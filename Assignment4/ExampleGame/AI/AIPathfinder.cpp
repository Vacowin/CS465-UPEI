	...
	m_pLineDrawer(NULL)
{
	...
	m_pLineDrawer->Init("Assignment4/ExampleGame/data/path/lines.vsh", "Assignment4/ExampleGame/data/path/lines.fsh");
}
...
void AIPathfinder::ToggleDebugRendering(Common::GameObjectManager* p_pGameObjectManager)
{
	...
	else
	{
		...
		for (int i = 0; i < m_lPathNodes.size(); ++i)
		{
			...
			pRenderableComponent->Init("Assignment4/ExampleGame/data/path/node.pod", "Assignment4/ExampleGame/data/path", "Assignment4/ExampleGame/data/shaders/textured.vsh", "Assignment4/ExampleGame/data/shaders/textured.fsh");
