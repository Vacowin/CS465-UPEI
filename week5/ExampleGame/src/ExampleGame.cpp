...
bool ExampleGame::Init()
{
	...
	//pRenderableComponent->Init("week5/ExampleGame/data/character/vincent.pod", "week5/ExampleGame/data/character/", "week5/ExampleGame/data/skinned.vsh", "week5/ExampleGame/data/skinned.fsh");
...
bool ExampleGame::Update(float p_fDelta)
{
	...
	bool result = ScriptUpdate(p_fDelta);
