...
void ComponentAnimController::InitDelegates()
{
	...
	if (pComponent)
	{
		...
		pCharController->RegisterWalkingDelegate(std::tr1::bind(&ComponentAnimController::StartWalkingDelegate, this, std::tr1::placeholders::_1));
		pCharController->RegisterStopWalkingDelegate(std::tr1::bind(&ComponentAnimController::StopWalkingDelegate, this, std::tr1::placeholders::_1));
	}
}
