...
namespace week2
{
	...
	public:
		...
		void RegisterWalkingDelegate(std::tr1::function<void (int testParam)> p_fFunction)		{ m_fWalkingDelegate = p_fFunction; }
		void RegisterStopWalkingDelegate(std::tr1::function<void (int testParam)> p_fFunction)	{ m_fStopWalkingDelegate = p_fFunction; }
	...
	private:
		...
		std::tr1::function<void (int testParam)> m_fWalkingDelegate;
		std::tr1::function<void (int testParam)> m_fStopWalkingDelegate;
