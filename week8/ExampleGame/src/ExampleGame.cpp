...
bool ExampleGame::Init()
{
	...
	pRenderableComponent->Init("week8/ExampleGame/data/character/vincent.pod", "week8/ExampleGame/data/character/", "week8/ExampleGame/data/skinned.vsh", "week8/ExampleGame/data/skinned.fsh");
	...
	pRenderableComponent->Init("week8/ExampleGame/data/zombie/zombie.pod", "week8/ExampleGame/data/zombie/", "week8/ExampleGame/data/skinned.vsh", "week8/ExampleGame/data/skinned.fsh");
